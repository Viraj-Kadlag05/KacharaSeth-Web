$(document).ready(function () {
   ...
   var config = {
    ...
    function calcBill(score) {
        ...
        var energyBill = 70/score * 300;
        var waterBill = 70/score * 200;

        $("#energy").html("Rs. "+energyBill.toFixed(2));
        $("#water").html("Rs. "+waterBill.toFixed(2));
        $("#energyd").html("+2.5%");
        $("#waterd").html("+4.5%");
    ...
    function nextMove(){
        ...
        am4core.ready(function() {
            ...
            $("#gauge2score").html(avg.toPrecision(2) + " bottles");
            setInterval(function() {
        ...
        function drawBarChart() {
            ...
            var data = google.visualization.arrayToDataTable([
              ...
              ['Other Garbage', avgS, '#B3D9FF'],
              ['Metal', avgL/3, '#88BBE4'],
              ['Plastic', avgH * 6, '#87DCC0'],
            ]);
        ...
        function drawLineChart() {
            ...
            var data = google.visualization.arrayToDataTable([
              ['Day', 'Plastic', 'Metal', 'Other Garbage'],
          ...
          var options = {
            chart: {
              ...
              subtitle: 'Plastic, Metal, and Other Garbage'
            },
            vAxes: {
                // Adds titles to each axis.
    ...
    function resizeGoogleCharts() {
      google.charts.setOnLoadCallback(drawBarChart);
        ...
        function drawLineChart() {
            ...
            var data = google.visualization.arrayToDataTable([
              ['Day', 'Other Garbage', 'Metal', 'Plastic'],
              ['Mon', showerH[0]*6, showerL[0], light[0]/3], //0,012
              ['Tues', showerH[1]*6, showerL[1], light[1]/3],
              ['Wed', showerH[2]*6, showerL[2], light[2]/3],
              ['Thurs', showerH[3]*6, showerL[3], light[3]/3],
